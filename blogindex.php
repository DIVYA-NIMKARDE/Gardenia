...
<div class="container">
    ...
    <div class="container mt-5">
        ...
        <div class="text-center">
            <a href="blogcreate.php"><button class="btn btn-outline-dark"> + Create a new Post</button></a>
        </div>
    </div>
                ...
                ?>
                    ...
                    <div class="card mt-5" style="width: 18rem; margin-left:50px;">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title"><?php echo "Posted by: ".$q['createdby']; ?></h5>
                            <a href="viewblog.php?id=<?php echo $q['id'] ?>" class="btn btn-primary">Read more</a>
                        </div>
                        </div>
                    </div>

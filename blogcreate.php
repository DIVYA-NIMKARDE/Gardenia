...
<body>
    ...
    <div class="container mt-5">
        <form method="POST">
            ...
            <textarea name="content" class="form-control  my-3 text-center" id="" cols="30" rows="10"></textarea>
            <input type="text" name="createdby" placeholder="Your Name" class="form-control my-3 text-center">
